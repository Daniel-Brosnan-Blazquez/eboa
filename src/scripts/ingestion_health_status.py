...
def main():
    ...
    values.append({
        ...
        "values": [
            ...
            {"name": "usage_percentage",
             "type": "double",
             "value": str(memory_usage.percent)},
            {"name": "used",
             "type": "double",
    ...
    if memory_usage.percent >= memory_max_threshold:
        alerts.append({
            "message": "Memory: maximum usage threshold ({}) reached with a value of {} %".format(memory_max_threshold, memory_usage.percent),
            "generator": os.path.basename(__file__),
            "notification_time": now,
            "alert_cnf": {
    ...
    if swap_usage.percent >= swap_max_threshold:
        alerts.append({
            "message": "Swap: maximum usage threshold ({}) reached with a value of {} %".format(swap_max_threshold, swap_usage.percent),
            "generator": os.path.basename(__file__),
            "notification_time": now,
            "alert_cnf": {
    ...
    for folder in health_xpath("/health/folders/folder"):
        ...
        if number_of_files >= folder.get("threshold_num_files"):
            alerts.append({
