"""
Automated tests for the engine submodule (event insertion type insert_and_erase_with_priority)
...
class TestInsertEventsInsertAndEraseWithPriorityAtDim(unittest.TestCase):
    def setUp(self):
    ...
    def test_insert_event_insert_and_erase_with_priority_at_dim_signature_level_inserted_in_the_middle_by_other_ingestion(self):
