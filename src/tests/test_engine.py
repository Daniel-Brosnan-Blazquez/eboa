...
class TestEngine(unittest.TestCase):
    ...
    #####
    # Test insertion type INSERT_and_ERASE_with_EQUAL_or_LOWER_PRIORITY
    #####
    def test_insert_and_erase_at_event_level_with_equal_or_lower_priority_with_split_event_crossing_validity(self):
        ...
        data = {"operations": [{
            ...
            "source": {"name": "source3.xml",
                       "reception_time": "2018-06-06T13:33:29",
                       "generation_time": "2017-07-06T02:07:03",
                       "validity_start": "2018-06-05T02:07:03",
                       "validity_stop": "2018-06-05T08:07:36",
                       "priority": 20},
            "events": [{
    ...
    def test_insert_and_erase_at_event_level_with_equal_or_lower_priority_with_no_events_during_one_period(self):
    ...
    def test_remove_deprecated_event_insert_and_erase_with_equal_or_lower_priority_lower_priority_greater_generation_time(self):
    ...
    def test_remove_deprecated_event_insert_and_erase_with_equal_or_lower_priority_lower_priority_greater_generation_time_no_defined_first_priority(self):
    ...
    def test_insert_event_insert_and_erase_with_equal_or_lower_priority_source_duration_0_in_the_middle_to_remove(self):
    ...
    def test_insert_event_insert_and_erase_with_equal_or_lower_priority_source_duration_0_in_the_middle_to_stay(self):
    ...
    def test_remove_deprecated_event_insert_and_erase_with_equal_or_lower_priority_same_period(self):
    ...
    def test_remove_deprecated_event_insert_and_erase_with_equal_or_lower_priority_one_starts_before_links(self):
    ...
    def test_remove_deprecated_event_insert_and_erase_with_equal_or_lower_priority_only_remains_last_inserted_source(self):
    ...
    def test_remove_deprecated_event_insert_and_erase_with_equal_or_lower_priority_long_event_cut(self):
    ...
    def test_remove_deprecated_event_insert_and_erase_with_equal_or_lower_priority_one_starts_after(self):
    ...
    def test_remove_deprecated_event_insert_and_erase_with_equal_or_lower_priority_events_not_overlapping(self):
    ...
    def test_remove_deprecated_event_insert_and_erase_with_equal_or_lower_priority_split_events(self):
    ...
    def test_remove_deprecated_event_insert_and_erase_with_equal_or_lower_priority_split_events_not_created(self):
    ...
    #####
    # Test insertion type INSERT_and_ERASE_INTERSECTED_EVENTS_with_PRIORITY
    #####
    def test_insert_and_erase_at_event_level_intersected_events_with_priority_with_split_event_crossing_validity(self):
    ...
    def test_insert_and_erase_at_event_level_intersected_events_with_priority_with_no_events_during_one_period(self):
    ...
    def test_remove_deprecated_event_insert_and_erase_intersected_events_with_priority_lower_priority_greater_generation_time(self):
    ...
    def test_remove_deprecated_event_insert_and_erase_intersected_events_with_priority_lower_priority_greater_generation_time_no_defined_first_priority(self):
    ...
    def test_insert_event_insert_and_erase_intersected_events_with_priority_source_duration_0_in_the_middle_to_remove(self):
    ...
    def test_insert_event_insert_and_erase_intersected_events_with_priority_source_duration_0_in_the_middle_to_stay(self):
    ...
    def test_insert_event_insert_and_erase_intersected_events_with_priority_partial_remove_with_links(self):
    ...
    def test_remove_deprecated_event_insert_and_erase_intersected_events_with_priority_same_period(self):
    ...
    def test_remove_deprecated_event_insert_and_erase_intersected_events_with_priority_one_starts_before_links(self):
    ...
    def test_remove_deprecated_event_insert_and_erase_intersected_events_with_priority_only_remains_last_inserted_source(self):
    ...
    def test_remove_deprecated_event_insert_and_erase_intersected_events_with_priority_long_event_cut(self):
    ...
    def test_remove_deprecated_event_insert_and_erase_intersected_events_with_priority_one_starts_after(self):
    ...
    def test_remove_deprecated_event_insert_and_erase_intersected_events_with_priority_events_not_overlapping(self):
    ...
    def test_remove_deprecated_event_insert_and_erase_intersected_events_with_priority_split_events(self):
        ...
        filtered_events_ddbb = self.session.query(Event).join(Source).filter(Event.start == "2018-06-05T04:07:36",
                                                                             Event.stop == "2018-06-05T12:07:03",
                                                                             Source.name == "source3.xml",
                                                                             Event.visible == True).all()

        assert len(filtered_events_ddbb) == 1

        filtered_events_ddbb = self.session.query(Event).join(Source).filter(Event.start == "2018-06-05T15:07:36",
                                                                             Event.stop == "2018-06-06T07:07:36",
                                                                             Source.name == "source3.xml",
                                                                             Event.visible == True).all()
    ...
    def test_remove_deprecated_event_insert_and_erase_intersected_events_with_priority_split_events_not_created(self):
        ...
        filtered_events_ddbb = self.session.query(Event).join(Source).filter(Event.start == "2018-06-05T04:07:36",
                                                                             Event.stop == "2018-06-05T09:07:03",
                                                                             Source.name == "source3.xml",
                                                                             Event.visible == True).all()
    ...
    def test_remove_deprecated_event_insert_and_erase_intersected_events_with_priority_period_without_events(self):
            ...
            "dim_signature": {"name": "dim_signature",
                 ...
                 "events": [{
                     ...
                     "gauge": {"name": "GAUGE_NAME",
                               "system": "GAUGE_SYSTEM",
                               "insertion_type": "INSERT_and_ERASE_INTERSECTED_EVENTS_with_PRIORITY"},
                     "start": "2018-06-05T16:07:03",
                     "stop": "2018-06-05T17:07:36"
                }]
        }]}
        ...
        filtered_events_ddbb = self.session.query(Event).join(Source).filter(Event.start == "2018-06-05T16:07:03",
                                                                             Event.stop == "2018-06-05T17:07:36",
                                                                             Source.name == "source3.xml",
                                                                             Event.visible == True).all()
    ...
    def test_remove_deprecated_event_insert_and_erase_intersected_events_with_priority_period_removing_previous_events_with_equal_priority(self):
        ...
        data3 = {"operations": [{
            ...
            "dim_signature": {"name": "dim_signature",
                 ...
                 "events": [{
                     ...
                     "explicit_reference": "SIMPLE_UPDATE",
                     "gauge": {"name": "GAUGE_NAME",
                               "system": "GAUGE_SYSTEM",
                               "insertion_type": "INSERT_and_ERASE_INTERSECTED_EVENTS_with_PRIORITY"},
                     "start": "2018-06-05T16:07:03",
        ...
        data4 = {"operations": [{
            ...
            "dim_signature": {"name": "dim_signature",
                                   "exec": "exec",
                                   "version": "1.0"},
                 "source": {"name": "source4.xml",
                            "reception_time": "2018-06-06T13:33:29",
                            "generation_time": "2018-07-06T02:07:04",
                            "validity_start": "2018-06-04T02:07:03",
                            "validity_stop": "2018-06-06T08:07:36",
                            "priority": 30},
                 "events": [{
        ...
        filtered_events_ddbb = self.session.query(Event).join(Source).filter(Event.start == "2018-06-04T02:07:03",
                                                                             Event.stop == "2018-06-04T03:07:36",
                                                                             Source.name == "source4.xml",
                                                                             Event.visible == True).all()
    ...
    def test_remove_deprecated_event_insert_and_erase_intersected_events_with_priority_no_events_removing_previous_events_with_equal_priority_lower_generation_time(self):
    ...
    def test_remove_deprecated_event_insert_and_erase_intersected_events_with_priority_no_events_removing_previous_events_with_equal_priority_same_generation_time(self):
        ...
        filtered_events_ddbb = self.session.query(Event).join(Source).filter(Event.start == "2018-06-05T06:07:03",
                                                                             Event.stop == "2018-06-05T08:07:36",
                                                                             Source.name == "source1.xml",
                                                                             Event.visible == True).all()
    ...
    def test_remove_deprecated_event_insert_and_erase_intersected_events_with_priority_no_events_removing_previous_events_with_lower_priority(self):
    ...
    def test_remove_deprecated_event_insert_and_erase_intersected_events_with_priority_no_events_not_removing_previous_events_with_greater_priority(self):
    ...
    def test_remove_deprecated_event_insert_and_erase_intersected_events_several_timelines_1(self):
        """
        Method to test the insertion method INSERT_and_ERASE_INTERSECTED_EVENTS_with_PRIORITY with the following scenario
        TIMELINE 1:         |--------------------------|            PRIORITY 30 GENERATION X -> INSERT_and_ERASE_per_EVENT_with_PRIORITY
        TIMELINE 2:         |---------------------------|           PRIORITY 30 GENERATION Y -> INSERT_and_ERASE_per_EVENT_with_PRIORITY
        TIMELINE 3: |--|        |-----------|    |         |--|     PRIORITY 10 -> INSERT_and_ERASE_INTERSECTED_EVENTS_with_PRIORITY
        Y > X
        ...
        data1 = {"operations": [{
            ...
            "dim_signature": {"name": "dim_signature",
                 ...
                 "source": {"name": "source1.xml",
                            "reception_time": "2018-06-06T13:33:29",
                            "generation_time": "2016-01-01T00:00:00",
                            "validity_start": "2018-06-05T00:00:00",
                            "validity_stop": "2018-06-06T00:00:00",
                            "priority": 30},
                 "events": [{
                     "explicit_reference": "EXPLICIT_REFERENCE_EVENT",
                     "gauge": {"name": "GAUGE_NAME",
            ...
            "dim_signature": {"name": "dim_signature",
                 ...
                 "events": [{
                     ...
                     "gauge": {"name": "GAUGE_NAME",
                               "system": "GAUGE_SYSTEM",
                               "insertion_type": "INSERT_and_ERASE_INTERSECTED_EVENTS_with_PRIORITY"},
                     "start": "2018-06-05T04:10:00",
                     "stop": "2018-06-05T04:30:00"
                 },{
                     "explicit_reference": "EXPLICIT_REFERENCE_EVENT",
                     "gauge": {"name": "GAUGE_NAME",
                               "system": "GAUGE_SYSTEM",
                               "insertion_type": "INSERT_and_ERASE_INTERSECTED_EVENTS_with_PRIORITY"},
                     "start": "2018-06-05T04:40:00",
                     "stop": "2018-06-05T04:40:00"
                 },{
                     "explicit_reference": "EXPLICIT_REFERENCE_EVENT",
                     "gauge": {"name": "GAUGE_NAME",
                               "system": "GAUGE_SYSTEM",
                               "insertion_type": "INSERT_and_ERASE_INTERSECTED_EVENTS_with_PRIORITY"},
                     "start": "2018-06-05T10:00:00",
                     "stop": "2018-06-05T11:00:00"
                 }]
        }]}
        ...
        filtered_events_ddbb = self.session.query(Event).join(Source).filter(Event.start == "2018-06-05T04:00:00",
                                                                             Event.stop == "2018-06-05T05:10:00",
                                                                             Source.name == "source2.xml",
                                                                             Event.visible == True).all()

        assert len(filtered_events_ddbb) == 1

        filtered_events_ddbb = self.session.query(Event).join(Source).filter(Event.start == "2018-06-05T02:00:00",
                                                                             Event.stop == "2018-06-05T03:00:00",
                                                                             Source.name == "source3.xml",
                                                                             Event.visible == True).all()

        assert len(filtered_events_ddbb) == 1

        filtered_events_ddbb = self.session.query(Event).join(Source).filter(Event.start == "2018-06-05T10:00:00",
                                                                             Event.stop == "2018-06-05T11:00:00",
                                                                             Source.name == "source3.xml",
                                                                             Event.visible == True).all()

        assert len(filtered_events_ddbb) == 1

    def test_remove_deprecated_event_insert_and_erase_intersected_events_several_timelines_2(self):
        """
        Method to test the insertion method INSERT_and_ERASE_INTERSECTED_EVENTS_with_PRIORITY with the following scenario
        TIMELINE 1:         |--------------------------|            PRIORITY 30 GENERATION X -> SIMPLE_UPDATE
        TIMELINE 2:         |---------------------------|           PRIORITY 30 GENERATION Y -> SIMPLE_UPDATE
        TIMELINE 3: |--|        |-----------|    |         |--|     PRIORITY 10 -> INSERT_and_ERASE_INTERSECTED_EVENTS_with_PRIORITY
        Y > X
        ...
        filtered_events_ddbb = self.session.query(Event).join(Source).filter(Event.start == "2018-06-05T04:00:00",
                                                                             Event.stop == "2018-06-05T05:00:00",
                                                                             Source.name == "source1.xml",
                                                                             Event.visible == True).all()
    ...
    def test_remove_deprecated_event_insert_and_erase_intersected_events_several_timelines_duplication_event_duration_0(self):
        """
        Method to test the insertion method INSERT_and_ERASE_INTERSECTED_EVENTS_with_PRIORITY with the following scenario
        TIMELINE 1:         |--------------------------|            PRIORITY 30 GENERATION X -> SIMPLE_UPDATE
        TIMELINE 2:         |---------------------------|           PRIORITY 30 GENERATION Y -> SIMPLE_UPDATE
