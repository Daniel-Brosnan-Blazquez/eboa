"""
Automated tests for the engine submodule (event insertion type INSERT_and_ERASE_INTERSECTED_EVENTS_with_PRIORITY)
...
class TestInsertEventsInsertAndEraseIntersectedEventsWithPriority(unittest.TestCase):
    def setUp(self):
    ...
    def test_event_with_duration_0_at_the_end_to_stay(self):
    ...
    def test_event_with_duration_0_with_higher_priority_in_the_middle_of_events_to_stay(self):
        ...
        data1 = {"operations": [{
            ...
            "source": {"name": "source1.json",
                       "reception_time": "2018-06-06T13:33:29",
                       "generation_time": "2022-07-07T02:07:03",
                       "validity_start": "2018-06-05T02:07:03",
                       "validity_stop": "2018-06-05T08:07:36",
                       "priority": 40},
            "events": [{
    ...
    def test_event_with_duration_0_in_the_middle_to_remove(self):
