"""
Automated tests for the engine submodule (event insertion type INSERT_and_ERASE_per_EVENT_with_PRIORITY)
...
class TestInsertEventsInsertAndErasePerEventWithPriority(unittest.TestCase):
    def setUp(self):
    ...
    def test_insert_event_insert_and_erase_per_event_with_priority(self):
    ...
    def test_insert_event_insert_and_erase_per_event_with_priority_event_not_ending_on_period(self):
    ...
    def test_insert_event_insert_and_erase_per_event_with_priority_event_inserted_in_the_middle_by_other_ingestion(self):
    ...
    def test_insert_event_insert_and_erase_event_duration_0_at_the_end_to_stay(self):
    ...
    def test_insert_event_insert_and_erase_event_duration_0_in_the_middle_of_events_to_remove(self):
    ...
    def test_insert_event_insert_and_erase_event_duration_0_with_higher_priority_in_the_middle_of_events_to_stay(self):
    ...
    def test_insert_event_insert_and_erase_per_event_events_duration_0_in_the_middle_to_remove(self):
