...
class TestInsertEventsInsertAndEraseWithPriorityAtEvent(unittest.TestCase):
    def setUp(self):
    ...
    def test_insert_event_insert_and_erase_with_priority_at_event_event_inserted_in_the_middle_by_other_ingestion(self):
