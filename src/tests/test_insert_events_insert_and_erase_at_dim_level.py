...
class TestInsertEventsInsertAndEraseAtDim(unittest.TestCase):
    def setUp(self):
    ...
    def test_insert_event_insert_and_erase_at_dim_signature_level_inserted_in_the_middle_by_other_ingestion(self):
    ...
    def test_insert_event_insert_and_erase_at_dim_signature_level_event_duration_0_at_the_end_to_stay(self):
    ...
    def test_insert_event_insert_and_erase_at_dim_signature_level_events_duration_0_in_the_middle_to_remove(self):
