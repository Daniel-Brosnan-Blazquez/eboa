...
class TestEngine(unittest.TestCase):
    ...
    def test_rep_ai(self):
        ...
        definite_archiving_times = self.query_eboa.get_annotations(annotation_cnf_names = {"op": "like", "filter": "ARCHIVING_TIME"},
                                                     explicit_refs = {"op": "like", "filter": "S2A_OPER_MSI_L1C_TC_MPS__20180721T001557_A016071_T14XMR_N02.06"})

        assert definite_archiving_times[0].get_structured_values() == [{
            'type': 'object',
            'name': 'details',
