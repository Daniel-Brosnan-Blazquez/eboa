...
class TestDec(unittest.TestCase):
    ...
    def test_rep_dec_remove_alert(self):
        ...
        received_sources_to_triggered = self.query_eboa.get_sources(names = {"filter": "matching_source", "op": "=="}, dim_signatures = {"filter": "PENDING_RECEIVED_SOURCES_BY_DEC", "op": "=="})

        assert len(received_sources_to_triggered) == 0
