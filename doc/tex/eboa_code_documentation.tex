...
\begin{fulllineitems}
\phantomsection\label{\detokenize{eboa.engine:eboa.engine.query.Query.get_linked_events}}\pysiglinewithargsret{\sphinxbfcode{\sphinxupquote{get\_linked\_events}}}{\emph{processing\_uuids=None}, \emph{explicit\_ref\_ids=None}, \emph{gauge\_ids=None}, \emph{start\_filters=None}, \emph{stop\_filters=None}, \emph{link\_names=None}, \emph{link\_name\_like=None}, \emph{event\_uuids=None}}{}
\end{fulllineitems}

\index{get\_linked\_events\_join() (eboa.engine.query.Query method)}

\begin{fulllineitems}
\phantomsection\label{\detokenize{eboa.engine:eboa.engine.query.Query.get_linked_events_join}}\pysiglinewithargsret{\sphinxbfcode{\sphinxupquote{get\_linked\_events\_join}}}{\emph{sources=None}, \emph{source\_like=None}, \emph{explicit\_refs=None}, \emph{explicit\_ref\_like=None}, \emph{gauge\_names=None}, \emph{gauge\_name\_like=None}, \emph{gauge\_systems=None}, \emph{gauge\_system\_like=None}, \emph{start\_filters=None}, \emph{stop\_filters=None}, \emph{link\_names=None}, \emph{link\_name\_like=None}, \emph{value\_filters=None}, \emph{values\_names\_type=None}, \emph{values\_name\_type\_like=None}}{}
\end{fulllineitems}
